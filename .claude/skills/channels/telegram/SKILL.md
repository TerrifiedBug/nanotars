...
description: >
  Telegram channel plugin — auth, setup, and installation. Adds Telegram as a channel.
  Can replace WhatsApp entirely or run alongside it. Not part of the core plugin set —
  requires `npm install grammy`. Triggers on "add telegram", "telegram setup", "telegram channel".
---
