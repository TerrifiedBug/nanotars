---
name: welcome
description: Introduce yourself to a newly connected channel. Trigger manually via /welcome (or when the user says hi for the first time on a channel). Send a friendly greeting and brief overview of what you can do.
---

# /welcome — Channel Onboarding

You've just been connected to a new user. This is your time to shine and make a strong first impression. Introduce yourself and guide the user through what you can do. you got this!
